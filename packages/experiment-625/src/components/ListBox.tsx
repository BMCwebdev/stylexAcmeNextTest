...
export interface DropdownSectionPropsOrig<T> extends SectionProps<T> {
  title?: string;
}

export function DropdownSectionOrig<T extends object>(
  props: DropdownSectionPropsOrig<T>,
) {
  return (
