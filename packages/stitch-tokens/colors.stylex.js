...
export const colorsBorder = defineVars({
  critical: colorsFeedback.critical,
  default: colorsAlpha.neutral_500,
  disabled: colorsAlpha.neutral_400,
  focused: colorsSymantic.primary,
  input: colors.neutral_800,
  primary: colorsSymantic.primary,
  selected: colorsSymantic.primary
});

export const colorsElevation = defineVars({
  background: colors.neutral_100,
  raised_lowest: colors.neutral_0,
...
export const colorsShadow = defineVars({
  default: colorsAlpha.neutral_300,
  raised_lowest: `0 1px 1px ${colorsAlpha.neutral_300}`,
  raised_low: `0 2px 4px ${colorsAlpha.neutral_300}, 0 0 1px ${colorsAlpha.neutral_300}`,
  raised_medium: `0 4px 8px ${colorsAlpha.neutral_300}, 0 0 1px ${colorsAlpha.neutral_300}`,
  raised_high: `0 8px 16px ${colorsAlpha.neutral_300}, 0 0 1px ${colorsAlpha.neutral_300}`
});
